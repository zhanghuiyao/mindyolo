...
from mindspore import Tensor, context, nn, ParallelMode, ops
...
def get_parser_test(parents=None):
    ...
    parser.add_argument("--ms_mode", type=int, default=1, help="train mode, graph/pynative")
    parser.add_argument("--ms_amp_level", type=str, default="O0", help="amp level, O0/O1/O2")
    parser.add_argument(
        "--ms_enable_graph_kernel", type=ast.literal_eval, default=False, help="use enable_graph_kernel or not"
    )
    parser.add_argument("--weight", type=str, default="./yolov8seg.ckpt", help="model.ckpt path(s)")
